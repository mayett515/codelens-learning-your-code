...
29. The remaining open work is:
    - extractor flip - decide when the real extractor consumes the ContextPack prompt builder
    - missing-concept UX - decide how noStrongMatch and suggestedNewConcept appear to the user
