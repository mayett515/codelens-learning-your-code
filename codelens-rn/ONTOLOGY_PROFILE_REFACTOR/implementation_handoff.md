...
28. The remaining open decisions are:
    - branch/overlay DB persistence - schema, migration, and store for ProfileBranch (persistence model locked in doc 13; domain-only ProfileBranch model implemented)
    - profile registry shape for resolving baseProfileId
