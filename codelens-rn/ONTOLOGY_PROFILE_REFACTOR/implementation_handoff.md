...
29. The remaining open work is:
    - runtime activation wiring - which layer reads persisted project selections, branch store, and profile registry before calling the Runtime Profile Coordinator
