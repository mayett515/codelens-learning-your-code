...
Richer missing-concept edit/apply flows:
  ...
  - next slice should decide the edited proposal/apply path after a user changes the suggested label, parent, reason, or target layer
