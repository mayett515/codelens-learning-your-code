...
- [43_SECOND_BASE_PROFILE_FORKABILITY_DEMO_DECISION.md](43_SECOND_BASE_PROFILE_FORKABILITY_DEMO_DECISION.md) - locked decision, not implemented: the first forkability proof should add a minimal photography base profile demo and tests that exercise registry, persisted profile definitions, project selection, branch creation, checker/proposal review, target switching, and base apply against a non-coding profile. The deliverable is the profile proof plus discovered coupling fixes/findings, not profile-gallery UX, cross-base behavior, new operation vocabulary, maturity lifecycle, source-sync, auto-apply, or a shipping decision for photography.
