...
- [39_EDIT_THEN_APPLY_DECISION.md](39_EDIT_THEN_APPLY_DECISION.md) - locked decision + implementation slices: richer missing-concept edit/apply is a review-time draft flow over pending proposals. Implemented slices add editable missing-concept meaning, proposal provenance, target readout, proposal-review handoff, superseding lifecycle, event-history readout, and a same-target edited replacement service/hook that validates an edited patch before creating a replacement pending proposal. Branch targets still apply through doc 24, base/core targets through doc 38. No visible proposal editor UI, direct Conceptualize apply, target switching UI, automatic missing-concept apply, checker runtime, old-card backfill, or auto-apply is added.
