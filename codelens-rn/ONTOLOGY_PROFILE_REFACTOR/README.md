...
- [39_EDIT_THEN_APPLY_DECISION.md](39_EDIT_THEN_APPLY_DECISION.md) - locked decision + implementation slices: richer missing-concept edit/apply is a review-time draft flow over pending proposals. Implemented slices add editable missing-concept meaning, proposal provenance, target readout, proposal-review handoff, superseding lifecycle, event-history readout, a same-target edited replacement service/hook, and a first visible proposal editor for supported new-node proposals. Branch targets still apply through doc 24, base/core targets through doc 38. No direct Conceptualize apply, target switching UI, automatic missing-concept apply, checker runtime, old-card backfill, or auto-apply is added.
...
- [FABLE_STRATEGIC_REVIEW_2026-06-09/](FABLE_STRATEGIC_REVIEW_2026-06-09/00-system-index.md) - Claude Fable strategic architecture review pack. Use as review guidance for Kordex's big-picture coherence, next gates, risks, future DSL/adapter constraints, and future LLM reading bundles. It does not override numbered decision docs.
